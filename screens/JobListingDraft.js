...
export default function JobListingDraft({ navigation }) {
	const handleNavigate = (screen) => {
		const screenMap = {
			...
			basicinformation: "JobListingDraft", // TODO: Add BasicInformation screen
		};
			...
			<View style={styles.headerContainer}>
				<View style={styles.column}>
					...
					<View style={styles.row2}>
						<TouchableOpacity style={styles.view} onPress={() => handleNavigate("active")}>
						...
						<View style={styles.row5}>
							<View style={styles.row2}>
								...
								<View style={styles.column4}>
									...
									<Image
										source={{ uri: "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/kIMs9oBBUY/1iksl2n6_expires_30_days.png" }}
										resizeMode="stretch"
										style={styles.image6}
									/>
								</View>
						...
						<View style={styles.row8}>
							<View style={styles.row2}>
								...
								<View style={styles.column5}>
									...
									<Image
										source={{ uri: "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/kIMs9oBBUY/j5nj7ulw_expires_30_days.png" }}
										resizeMode="stretch"
										style={styles.image7}
									/>
								</View>
						...
						<View style={styles.row10}>
							<View style={styles.row2}>
								...
								<View style={styles.column7}>
									...
									<Image
										source={{ uri: "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/kIMs9oBBUY/mxh0dpx1_expires_30_days.png" }}
										resizeMode="stretch"
										style={styles.image8}
									/>
								</View>
