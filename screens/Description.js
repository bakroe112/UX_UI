	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<ScrollView  style={styles.scrollView}>
					...
					<View style={styles.column5}>
						...
						<View style={styles.row7}>
							<View style={styles.column6}>
								...
								/>
								<Image
									source = {{uri: "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/kIMs9oBBUY/o28nmjcm_expires_30_days.png"}} 
									resizeMode = {"stretch"}
									style={styles.image8}
								/>
							</View>
				...
				<TouchableOpacity style={styles.button2} onPress={() => navigation.navigate("Requirements")}>
					<Text style={styles.text}>
						{"Next: Requirements"}
					</Text>
				</TouchableOpacity>
