...
export default (props) => {
	return (
		<View style={{ display: props.currentScreen === "screeningqs" ? "flex" : "none", flex: 1 }}>
			<View style={styles.container}>
				<View style={styles.fixedHeader}>
					<View style={styles.column}>
						<View style={styles.row3}>
							<View style={styles.backHeader}>
								<TouchableOpacity onPress={() => props.onNavigate("requirements")}>
									<Image
				...
				<ScrollView  style={styles.scrollView}>
					...
					<TouchableOpacity style={styles.publishButton} onPress={() => props.onNavigate("review")}>
